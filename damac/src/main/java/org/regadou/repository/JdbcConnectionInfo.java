...
public class JdbcConnectionInfo {
   ...
   public JdbcConnectionInfo(String url, Map<String, JdbcVendor> vendorMap) {
      String txt;
      String[] parts;
      if (url == null || url.trim().equals("") || !url.startsWith("jdbc:")) {
         ...
         this.vendor = vendorMap.get(name);
         if (this.vendor == null) {
   ...
   public boolean equals(Object o) {
      if (o instanceof JdbcConnectionInfo) {
         ...
         return this.url.equals(that.url) && this.user.equals(that.user);
      }
      return false;
   }
